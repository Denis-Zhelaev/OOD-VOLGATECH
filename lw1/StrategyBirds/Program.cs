...
/*
Создайте консольное приложение на С++ (переделал на С# для лучшего понимания синтаксиса) 
моделирующее работу с птицами. 
Должна быть возможность создавать список птиц и дополнять их, 
давать им имена и определять их вид.
В зависимости от вида у птиц существуют разные способности.
Реализуйте паттерн стратегия для реализации разного поведения птиц.
Создайте вид птиц, который не умеет делать одно из действий (летать, плавать, крякать).
Создайте класс реактивной утки из лекционного материала.
